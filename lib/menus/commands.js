...
var add_success = function (message = null, opts = {}) {
  default_opts = {
    dismissable: true,
  };
  ...
  return atom.notifications.addSuccess(message, default_opts);
};
var add_info = function (message = null, opts = {}) {
  default_opts = {
    dismissable: true,
  };
  ...
  return atom.notifications.addInfo(message, default_opts);
};
var add_error = function (message = null, opts = {}) {
  default_opts = {
    dismissable: true,
  };
  ...
  return atom.notifications.addError(message, default_opts);
};
var add_warning = function (message = null, opts = {}) {
  default_opts = {
    dismissable: true,
  };
  ...
  return atom.notifications.addWarning(message, default_opts);
};

var _success, _info, _error, _warning;
  ...
  const commands = {
    ...
    'remote-ftp:connect': {
      ...
      command() {
        ...
        client.readConfig((e) => {
          ...
          _success = add_success('Connected!');
          setTimeout(() => {
            _success.dismiss();
          }, 600);
        });
    ...
    'remote-ftp:disconnect': {
      ...
      command() {
        ...
        _success = add_success('Disconnected!');
        setTimeout(() => {
          _success.dismiss();
        }, 500);
      },
    ...
    'remote-ftp:download-active': {
      ...
      command() {
        ...
        client.download(downloadItem, true, () => {
          _info.dismiss();
          _success = add_success('Downloaded!');
          setTimeout(() => {
            _success.dismiss();
          }, 600);
        });
